...
public class CatalogoTest {
    ...
    public void testAgregarObra() throws Exception{
        catalogo.agregarObra(new ObraDeArte("Jarrón con acianos y amapolas", new Autor("Vincent Van Gogh ")));
    ...
    public void testExisteObra() throws Exception{
        catalogo.agregarObra(new ObraDeArte("Jarrón con acianos y amapolas", new Autor("Vincent Van Gogh ")));
        Assert.assertTrue(catalogo.existeObra(new ObraDeArte("Jarrón con acianos y amapolas", new Autor("Vincent Van Gogh "))));
    }
